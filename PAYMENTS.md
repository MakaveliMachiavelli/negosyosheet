# PAYMENTS.md — NegosyoSheet monetization setup (Allen's ~5-minute step)
...
The full workbook is served from `/full/NegosyoSheet.xlsx` (blocked in robots.txt but technically a public URL — a buyer could share the direct link). Fine for ₱149-at-this-scale. When sales justify it (say 20+/mo):
1. Create Gumroad/LemonSqueezy product "NegosyoSheet ₱149" with the xlsx as auto-delivered content.
